...
sentence, hopefully you get what I mean.)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{c+c1}{\PYZsh{} Calculate probability of conversion for new page}
...
Probability of conversion for new page: 0.11880806551510564
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}46}]:} \PY{c+c1}{\PYZsh{} Calculate probability of conversion for old page}
...
\(p_{new_0} - p_{old_0}= 0\)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}47}]:} \PY{c+c1}{\PYZsh{} Calculate n\PYZus{}new and n\PYZus{}old}
...
new\_page\_converted.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}48}]:} \PY{c+c1}{\PYZsh{} Simulate conversion rates under null hypothesis}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}48}]:} 0.11902828435758035
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
100\%|██████████| 10000/10000 [00:40<00:00, 243.96it/s]
...
to assure you fully understand what was computed here.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}50}]:} \PY{c+c1}{\PYZsh{} Plot histogram}
...
{\color{outcolor}Out[{\color{outcolor}38}]:} <class 'statsmodels.iolib.summary2.Summary'>
         ...
         Date:               2017-11-22 14:04 AIC:              212780.3502
...
{\color{outcolor}Out[{\color{outcolor}42}]:} <class 'statsmodels.iolib.summary2.Summary'>
         ...
         Model:              Logit            No. Iterations:   6.0000     
         Dependent Variable: converted        Pseudo R-squared: 0.000      
         Date:               2017-11-22 14:04 AIC:              212780.8333
